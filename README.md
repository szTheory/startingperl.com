...
Why learn Perl in 2020? Unlike Ruby and Python3 it's installed on any almost any box you SSH into. Because of that and it's [famously quick startup time](https://github.com/bdrung/startup-time) you can use Perl like a faster, more robust and portable bash script. Unlike Python and Go it has [great support for functional programming](https://hop.perl.plover.com/book/), including a filter/map/reduce and tail call optimization. Unlike JavaScript, the ecosystem is stable so you can avoid churn. [Unlike Python](https://learning-python.com/python-changes-2014-plus.html), Perl is incredibly stable and avoiding breaking changes is one of its highest priorities. It has a proven track record of 30+ years, so you're bound to run into it somewhere. Many best-in-class tools are written in Perl, like the famous [exiftool](https://exiftool.org/). It has a strong presence in web development, system administration, and [data science](https://bioperl.org/). It's one of the [highest paid programming languages](https://fossbytes.com/stack-overflow-highest-salary-programming-languages-2020/).
