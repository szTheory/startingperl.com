...
Why learn Perl in 2020? Unlike Ruby and Python3 it's installed on almost any box you log into and [has lightning fast startup times](https://github.com/bdrung/startup-time), so you can use it like a quicker, more robust and portable bash script. Unlike Python and Go it has [great support for functional programming](https://hop.perl.plover.com/book/) including a filter/map/reduce and tail call optimization. Unlike JavaScript, the ecosystem is stable so you can avoid framework churn. The language is incredibly stable and the Perl team makes a serious committment to full backwards compatibility. It has a proven track record of 30+ years, so you're bound to run into it somewhere. Many best-in-class tools are written in Perl, like the famous [exiftool](https://exiftool.org/). It has a strong presence in web development, system administration, and data science. It's one of the [highest paid programming languages](https://fossbytes.com/stack-overflow-highest-salary-programming-languages-2020/).
